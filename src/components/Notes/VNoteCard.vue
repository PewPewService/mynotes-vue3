  ...
  <div class="card note flex-card mb-4 mx-auto">
    <div class="card-body">
      ...
      <div class="note__management-buttons">
        <button
          :id="Note.id"
          :class="`btn btn-secondary note__management-buttons__button
        ...
        <button 
          :id="Note.id"
          class="btn btn-secondary note__management-buttons__button note__management-buttons__button_edit"
          title="edit"
          @click="EditNote"
        />
        <button
          :id="Note.id"
          class="btn btn-secondary note__management-buttons__button note__management-buttons__button_copy"
          title="copy"
          @click="CopyNote"
        />
        <button
